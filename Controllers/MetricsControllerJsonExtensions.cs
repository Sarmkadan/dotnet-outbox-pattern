...
/// <summary>
/// Provides System.Text.Json serialization and deserialization extensions for <see cref="MetricsController"/>
/// </summary>
/// <remarks>
/// Enables JSON serialization of controller instances for persistence, caching, or state transfer scenarios.
/// Serialization preserves controller state including injected dependencies and configuration.
/// </remarks>
public static class MetricsControllerJsonExtensions
{
    ...
    /// </summary>
    /// <param name="value">The <see cref="MetricsController"/> instance to serialize.</param>
    ...
    /// <returns>A <see cref="MetricsController"/> instance populated from JSON, or null if deserialization fails.</returns>
