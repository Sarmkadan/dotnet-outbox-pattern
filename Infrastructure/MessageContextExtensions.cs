...
/// <summary>
/// Extension methods for <see cref="MessageContext"/> providing convenient operations
/// for distributed tracing and message context management
/// </summary>
public static class MessageContextExtensions
{
    ...
    /// <param name="operationName">Name of the operation being performed</param>
    /// <returns>A disposable activity scope for the tracing operation</returns>
    /// <exception cref="ArgumentException">Thrown when serviceName or operationName is null or empty</exception>
    ...
    /// <param name="attributes">Optional attributes to include with the event</param>
