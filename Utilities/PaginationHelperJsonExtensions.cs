...
/// <summary>
/// Provides System.Text.Json serialization extensions for <see cref="PaginationMetadata"/>
/// </summary>
public static class PaginationHelperJsonExtensions
{
    ...
    /// <summary>
    /// Serializes a <see cref="PaginationMetadata"/> instance to a JSON string.
    /// </summary>
    /// <param name="value">The pagination metadata to serialize</param>
    ...
    /// <summary>
    /// Deserializes a JSON string to a <see cref="PaginationMetadata"/> instance.
    /// </summary>
    ...
    /// <summary>
    /// Attempts to deserialize a JSON string to a <see cref="PaginationMetadata"/> instance.
    /// </summary>
    /// <param name="json">The JSON string to deserialize</param>
    ...
    public static bool TryFromJson(string json, out PaginationMetadata? value)
    {
        ...
        try
        {
            value = JsonSerializer.Deserialize<PaginationMetadata>(json, _jsonOptions);
            return true;
        }
        catch (JsonException)
        {
